...
public class ProxyProvider extends AbstractProxyProvider {
    ...
    public <T> T createProxy(ClassLoader classLoader, Object target, Interceptor interceptor, Class<?>... proxyClasses) {
        return createProxyHere(classLoader, new InterceptorInvoker(target, interceptor), proxyClasses);
    }

    private <T> T createProxyHere(ClassLoader classLoader, ObjectInvoker invoker, final Class<?>... proxyClasses) {
