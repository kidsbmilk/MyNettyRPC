...
public class ModuleMetricsProcessor {
    ...
    private final static String TABLE_BEGIN = "<html><body><div class=\"table-container\"><table border\"1\"><tr>" +
            "<th>模块名称</th>" +
            "<th>方法名称</th>" +
            "<th>调用次数</th>" +
            "<th>调用成功次数</th>" +
    ...
    private final static String JMX_METRICS_ATTR = "ModuleMetricsVisitorList";
    ...
    public String buildModuleMetrics() {
        ...
        try {
            ...
            if (obj instanceof CompositeData[]) {
                for (CompositeData data : (CompositeData[]) obj) {
